    ...
    */
    var eventsConfig = {
          ...
          "recordTypes": [
            ...
            {"id": 10, "label": "recipe start", "mask": "@Destination#dest$/$@Need#0.001,1,kg$/$@Variant3#0.000277778,1,hrs"},
            {"id": 14, "label": "recipe end", "mask": "@Destination#dest$/$@Actual#0.001,1,kg$/$@TimeEnd#0.000277778,1,hrs$/$, BatchNo:$@BatchNo"},
            ...
            {"id": 35, "label": "fermentation", "mask": "Tank: $@Destination#dest$,Duration: $@Actual#0.000277778,1,hrs$/$@Need#0.000277778,1,hrs$,Temp: $@Variant1#0.1,1,°C"},
            {"id": 36, "label": "cooling", "mask": "Tank: $@Destination#dest$,Duration: $@Actual#0.000277778,1,hrs$/$@Need#0.000277778,1,hrs$,Temp: $@Variant2#0.1,1,°C$/$@Variant1#0.1,1,°C"},
            {"id": 37, "label": "storing", "mask": "Tank: $@Destination#dest$,Duration: $@Actual#0.000277778,1,hrs$/$@Need#0.000277778,1,hrs"},
    ...
    */
    ...
    function getAlarmConfig() {
      ...
      var url_1 = 'graph/getAlarmConfig?plc=' + plc;
